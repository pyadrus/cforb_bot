...
async def admin_send_start(message: types.Message, state: FSMContext):
    ...
    await message.answer("Команды админа:\n\n"
                         ...
                         "✔️ /edit_types_of_packaging - редактирование: Виды упаковки\n"
                         "✔️ /edit_services_and_prices - редактирование: Услуги и цены\n"
                         "✔️ /edit_wooden_sheathing_bag_tape - редактирование: Деревянные уголки + мешок + скотч\n"
                         "✔️ /edit_order_form - редактирование: 🗒 Бланк заказа\n"
                         "✔️ /edit_bag_tape - редактирование: Мешок + скотч\n"
                         "✔️ /edit_box_bag_tape - редактирование: Коробка + мешок + скотч\n"
                         "✔️ /edit_pallet_crate - редактирование: Паллет в обрешетке\n"
                         "✔️ /edit_pallet_with_a_solid_wooden_box - редактирование: Паллет с глухим деревянным коробом\n"
                         "✔️ /edit_wooden_sheathing_bag_tape - редактирование: Деревянная обрешетка + мешок + скотч\n"
                         "✔️ /edit_cargo_delivery_prices - редактирование: Прайсы на доставку Карго\n"
                         "✔️ /edit_goods_redemption_service - редактирование: Услуга Выкупа товаров\n"
                         "✔️ /edit_product_search_service - редактирование: Услуга Поиска товаров (производителей в "
                         "Китае)\n\n"
                         "✔️ /edit_supplier_inspection - редактирование: Инспекция поставщиков по провинциям "
                         "(выезд на производство)\n"
                         "✔️ /edit_wechat_registration_service - редактирование: Услуга регистрации в WeChat\n"
                         "✔️ /edit_purchase_a_supplier_database - редактирование: Приобрести базу данных поставщиков\n"
                         "✔️ /edit_what_payments_await_me - редактирование: Какие платежи меня ожидают?\n"
                         "✔️ /edit_how_is_payment_made - редактирование: Как совершается оплата?\n\n"
                         "✔️ /edit_self_redemption - редактирование: 🛍 Самовыкуп\n"
                         "✔️ /edit_reviews - редактирование: 💌 Отзывы\n"
                         "✔️ /edit_partnership_conditions_for_intermediaries_button - редактирование: Партнерские "
