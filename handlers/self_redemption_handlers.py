...
async def self_redemption(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        greeting_message = (f"Работаем только от 20 кг!\n\n"
                            ...
                            f"• После отправки поставщиком груза на наш склад, клиент самостоятельно контролирует трек "
                            f"номера и приход товара к нам на склад, когда все трек номера дошли к нам на склад, "
                            ...
                            f"Если вам необходимо проверить количество товара на соответствие, мы предоставляем данную "
                            f"услугу, стоимость 1¥ за счетную единицу.\n\n"

                            f"Так же осуществляем проверку на брак, стоимость 1-3¥ за счетную единицу (зависит от вида "
                            f"и упаковки товара)\n\n"
