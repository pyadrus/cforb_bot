...
async def partnership_conditions_for_intermediaries(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        greeting_message = (f"ПРЕДОСТАВИМ ФОТО\n\n"
                            f"<b>Если вы являетесь посредником по бизнесу с Китаем,</b> доставляете груз и работаете "
                            f"с другой компанией, блогером, менеджером по WB, у вас есть свой канал, группа или "
                            f"курсы👍\n\n"
                            
                            f"<b>Мы призываем рассмотреть нашу компанию для сотрудничества.</b>\n\n"
                            
                            f"<b>•</b> Обговорим и согласуем особенные условия именно для ВАС\n"
                            f"<b>•</b> Вы станете нашим полноценным партнером, получите первые цены, комфорт и "
                            f"удобство в работе с Китаем.\n"
                            f"<b>•</b> Поделимся знаниями и опытом\n\n"
                            ...
                            f"В нашей практике есть действующие и реальные кейсы полноценного партнерства с "
                            f"российскими крупными посредниками!\n\n"
