...
async def useful_information(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        greeting_message = (f'<b>Специально для Вас, наша компанию подготовила статьи с полезной информацией, это '
                            ...
                            f'<a href="https://cforb.ru/kak-prinimat-gruz-iz-kitaya">Правила приемки груза из Китая в России</a>\n'
                            ...
                            f'<a href="https://cforb.ru/poisk-tovara-v-kitae-samomu">Самостоятельный поиск товара. Преимущества</a>\n'
